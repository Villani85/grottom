...
// PUT /api/admin/courses/[id]/modules/[moduleId] - Aggiorna modulo
export async function PUT(
  ...
  try {
    ...
    const validatedData = moduleSchema.partial().parse(body)

    await ModulesRepository.update(id, moduleId, validatedData)
...
// DELETE /api/admin/courses/[id]/modules/[moduleId] - Elimina modulo
